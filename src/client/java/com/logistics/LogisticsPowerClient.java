...
import com.logistics.power.render.CreativeEngineBlockEntityRenderer;
...
public final class LogisticsPowerClient implements DomainBootstrap {
    ...
    public void initClient() {
        ...
        BlockEntityRenderers.register(
                LogisticsPower.ENTITY.CREATIVE_ENGINE_BLOCK_ENTITY, CreativeEngineBlockEntityRenderer::new);
